  ...
  .post(
    ...
    },
    {
      ...
      body: t.Object({
        ...
        setpointPressure: t.Optional(t.Number()),
        setpointFlow: t.Optional(t.Number()),
        setpointLevel: t.Optional(t.Number()),
        ...
        regPressure: t.Optional(t.Nullable(t.Integer({ minimum: 0 }))),
        regFlow: t.Optional(t.Nullable(t.Integer({ minimum: 0 }))),
        regLevel: t.Optional(t.Nullable(t.Integer({ minimum: 0 }))),
        ...
        scalePressure: t.Optional(t.Nullable(t.Number())),
        scaleFlow: t.Optional(t.Nullable(t.Number())),
        scaleLevel: t.Optional(t.Nullable(t.Number())),
        offsetPressure: t.Optional(t.Nullable(t.Number())),
        offsetFlow: t.Optional(t.Nullable(t.Number())),
        offsetLevel: t.Optional(t.Nullable(t.Number())),
      }),
    }
  )
